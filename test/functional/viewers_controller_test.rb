...
class ViewersControllerTest < ActionController::TestCase
  ...
  test "should create viewer" do
    assert_difference('Viewer.count') do
      post :create, viewer: { country: @viewer.country, email: @viewer.email, name: @viewer.name, pub: @viewer.pub }
    end
  ...
  test "should update viewer" do
    put :update, id: @viewer, viewer: { country: @viewer.country, email: @viewer.email, name: @viewer.name, pub: @viewer.pub }
    assert_redirected_to viewer_path(assigns(:viewer))
  end
